...
ENTRYPOINT ["java","-jar","-Dserver.port=8080","-Djava.io.tmpdir=/usr/local/GSB/logs","-Dspring.jpa.show-sql=false","-Dspring.jpa.hibernate.ddl-auto=update","-Dspring.boot.admin.client.url=http://172.16.0.145:5061","-Dssh.lead.username=soft","-Dssh.lead.password=Soft2","-Dssh.lead.address=172.16.0.145","-Dssh.lead.port=22","-Dspring.datasource.password=P@ssw0rd","-Dssh.lead.password=P@ssw0rd","/GSBJobEngine.war"]
